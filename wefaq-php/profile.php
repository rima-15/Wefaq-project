...
$user_ID = $_GET['user_ID']; // Get user ID dynamically
...
while ($skill = $skills_result->fetch_assoc()) {
    $percentage = min(100, max(0, $skill['avg_rating'])); 
    $skill_class = "skill" . $skill_index;
    $custom_styles .= ".$skill_class { width: {$percentage}%; }\n";
    $skills[] = ["name" => $skill['skill_name'], "percentage" => $percentage, "class" => $skill_class];
    $skill_index++;
}
?>
<!DOCTYPE html>
            ...
            <div class="profilePage-content">
                <div class="profilePage-info">
                    ...
                    <div class="profilePage-header Profilecard">
                        ...
                        <div class="profilePage-image-container Profilecard__avatar">
                    ...
                    <div class="profilePage-details">
                        ...
                        <div class="info-group">
                            <label>Bio</label>
                            <p>Full-stack developer passionate about creating efficient solutions</p>
                        </div>
                        <div class="info-group">
                            <label>Type</label>
                            <p>Professional</p>
